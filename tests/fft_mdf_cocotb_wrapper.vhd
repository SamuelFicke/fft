...
entity fft_mdf_cocotb_wrapper is
  ...
  port (
    ...
    Data_Out_I  : out std_logic_vector((fft_output_width(G_SAMPLE_WIDTH, G_FFT_SIZE) * G_SAMPLES_PER_CLK) - 1 downto 0);
    Data_Out_Q  : out std_logic_vector((fft_output_width(G_SAMPLE_WIDTH, G_FFT_SIZE) * G_SAMPLES_PER_CLK) - 1 downto 0);
